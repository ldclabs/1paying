...
<div
  {@attach init}
  popover="manual"
  class="pointer-events-none fixed top-auto right-4 bottom-4 left-auto z-9999 m-0 flex max-w-sm flex-col items-end gap-2 border-0 bg-transparent p-0 outline-none"
>
